<template>
  ...
  <div class="webm-desc">
    <div>
      <p>
        Opieka nad stroną przeznaczona jest dla klientów ceniących sobie spokój
        i stabilność w biznesie.
        <a href="https://informatyk360.pl/">itDesk</a> przejmuje na siebie
        obowiązki konserwacji, archiwizacji, aktualizacji, zabezpieczania oraz
        rozwoju systemu Klienta.
      </p>
      <p>
  ...
  <div class="table-cont">
    <h2>Pakiet <strong>BASIC</strong> - naliczanie godzinowe</h2>
    <div class="table">
      <div class="col">
        <div>
        ...
        <div>
          <p>Cena za rok<br />(1 miesiąc gratis)</p>
          <h3>1650 PLN</h3>
        </div>
      </div>
      <div class="col">
  ...
  <div class="table-cont second">
    <h2>Pakiet <strong>STANDARD</strong> - naliczanie co 30 minut</h2>
    <div class="table">
      <div class="col">
        <div>
          <h3>Strona internetowa</h3>
        ...
        <div>
          <p>Liczba godzin w pakiecie / ms:</p>
          <h3>2</h3>
        </div>
        <div>
          <p>Dodatkowa godzina pracy:</p>
  ...
  <div class="table-cont third">
    <h2>Pakiet <strong>PREMIUM</strong> - naliczanie minutowe</h2>
    <div class="table">
      <div class="col">
        <div>
          <h3>Strona internetowa</h3>
    ...
    <p>Parametry oraz wycena przygotowywana indywidualnie</p>
  </div>
  <div class="webm-info">
    <p>
      Wszystkie ceny w ofercie to ceny netto do których należy doliczyć podatek
      VAT.
    </p>
  </div>
  <OssBoxMain />
...
<style scoped lang="scss" src="./WebsiteMaintenance.style.scss"></style>
