  ...
  <div class="off-box">
    <div class="box">
      ...
      <div>
        ...
        <p>
          ...
          internetowych. Nasi fachowcy pomogą Ci w wyborze odpowiedniego Systemu
          dla Ciebie.
        </p>
      </div>
    </div>
    <div class="box">
      ...
      <div>
        ...
        <p>
          Oferujemy tanie strony internetowe w oparciu o gotowe lub indywidualne
          projekty graficzne.
        </p>
      </div>
    </div>
...
<style scoped lang="scss" src="./OssBoxMain.style.scss"></style>
